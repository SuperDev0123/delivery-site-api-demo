...
urlpatterns += [
    ...
    url(r"^upload/attachments/filename/", AttachmentsUploadView.as_view()),
    url(r"^upload/label/filename/", LabelUploadView.as_view()),
    url(r"^upload/pod/filename/", PodUploadView.as_view()),
