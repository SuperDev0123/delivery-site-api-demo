...
urlpatterns += [
    ...
    url(r"^upload/attachments/(?P<filename>[^/]+)$", AttachmentsUploadView.as_view()),
    url(r"^upload/label/(?P<filename>[^/]+)$", LabelUploadView.as_view()),
    url(r"^upload/pod/(?P<filename>[^/]+)$", PodUploadView.as_view()),
