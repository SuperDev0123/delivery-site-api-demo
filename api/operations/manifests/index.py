...
def build_manifest(booking_ids, username="", need_truck=False):
    ...
    if vx_freight_provider == "DHL":
        file_name = build_DHL_manifest(bookings, booking_lines, username, need_truck)
    elif vx_freight_provider == "TAS":
        file_name = build_TAS_manifest(bookings, booking_lines, username, need_truck)
    else:
        file_name = build_default_manifest(
            bookings, booking_lines, username, need_truck
        )
