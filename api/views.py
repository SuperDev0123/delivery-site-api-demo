            ...
            if client_process is None:
                ...
                if 'Tempo' in booking.b_client_name and booking.b_booking_Category == 'Salvage Expense':
                    ...
                    if booking.pu_Address_street_2 == '' or booking.pu_Address_street_2 == None:
                        ...
                        custRefNumVerbage = "Ref: " + str(booking.b_clientReference_RA_Numbers or '') + " Returns 4 " + booking.b_client_name + ". Fragile"
                        booking.pu_Address_Street_1 = custRefNumVerbage
                        booking.de_Email = str(booking.de_Email or '').replace(";", ",")
                        booking.de_Email_Group_Emails =  str(booking.de_Email_Group_Emails or '').replace(";", ",")
                        booking.pu_pickup_instructions_address = str(booking.pu_pickup_instructions_address or '') + " " + custRefNumVerbage
