...
def mapBokToBooking(request):
    ...
    try:
        ...
        run_time = (
            ...
            - option_value.start_time.replace(tzinfo=None)
        ).seconds
        message = ""
        if not option_value.is_running or run_time > 0:
            ...
            while bookingID_Visual <= end_id:
                ...
                if len(booking) > 0:
                    ...
                    pk_id_dme_client = (
                        dme_client.pk_id_dme_client if dme_client else None
                    )
                    if first_name == "Bathroom":
                        booking.booking_Created_For_Email = (
                            "info@bathroomsalesdirect.com.au"
                        )
                        booking.save()
                    else:
                        ...
                        booking.booking_Created_For_Email = (
                            booking_created_for_email[0].email
                    ...
                    if api_booking_quote_id:
                        ...
                        booking.inv_sell_quoted = (
                            booking_quote.client_mu_1_minimum_values
                        )
