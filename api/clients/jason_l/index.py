...
def push_boks(payload, client, username, method):
    ...
    with transaction.atomic():
        for index, item in enumerate(items):
            ...
            line["zbld_131_decimal_1"] = item["zbld_131_decimal_1"]
            line["zbl_102_text_2"] = (
    ...
    if repack_status:  # repack
        ...
        if pallet_id == -1:  # Use DME AI for Palletizing
            ...
            for bok_2 in bok_2s:
                ...
                bok_3[
                    "ld_005_item_serial_number"
                ] = bok_2.zbld_131_decimal_1  # Sequence
                ...
                bok_3["zbld_121_integer_1"] = bok_2.zbld_131_decimal_1  # Sequence
        ...
        for sscc in sscc_list:
            ...
            for picked_item in picked_items:
                ...
                for line in original_lines:
                    if line.zbld_131_decimal_1 == picked_item["items"][0]["sequence"]:
                        original_line = line
                ...
                line_data.itemSerialNumbers = original_line.zbld_131_decimal_1
                line_data.save()
