...
def build_manifest(booking_ids, one_manifest_file, username):
    ...
    fp_info = Fp_freight_providers.objects.get(fp_company_name=bookings[0]['vx_freight_provider'])
    ...
    if one_manifest_file == 0:
        ...
        for booking in bookings:
            try:
                ...
                mycursor.execute(sql, (booking['pk_booking_id'], filename, manifest, '1', '0', str(datetime.utcnow()), str(datetime.utcnow()), username))
