...
def build_xml(booking_ids, vx_freight_provider, one_manifest_file):
    ...
    if vx_freight_provider.lower() == "allied":
        ...
        if production:
            ...
            local_filepath = "./static/xmls/statetransport_au/"
            local_filepath_dup = (
                "./static/xmls/statetransport_au/archive/"
                + str(datetime.now().strftime("%Y_%m_%d"))
                + "/"
            )
        ...
        try:
            for booking in bookings:
                ...
                File = xml.Element("FILE")
                FileName = xml.SubElement(File, "FILENAME")
                FileName.text = "STATETRANSPORT_BOOKING_" + str(
                    datetime.now().strftime("%Y_%m_%d")
                )
                ...
                AdditionalInstructions.text = "State transport Service"
