            ...
            for k in range(booking_line.e_qty):
                ...
                tbl_data3 = [
                    [
                        Paragraph(
                            "<font size=%s><b>%s</b></font>"
                            % (label_settings["font_size_small"], "AUTHORITY TO LEAVE"),
                            style_center,
                        )
                    ],
                    [
                        code128.Code128(
                            barcode, barHeight=6 * mm, barWidth=1.2, humanReadable=True
                        )
                    ],
                ]
                ...
                tbl_data1 = [
                    [
                        code128.Code128(
                            barcode, barHeight=22 * mm, barWidth=1.3, humanReadable=True
                        )
                    ]
                ]
                ...
                tbl_data = [
                    [
                        code128.Code128(
                            barcode, barHeight=20 * mm, barWidth=0.9, humanReadable=True
                        )
                    ],
                ]
