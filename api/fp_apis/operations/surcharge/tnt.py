...
def rsp30(param):
    if param['pu_address_type'] == 'residential' and param['max_weight'] >= 30 and param['max_weight'] < 100:
        return {
...
def rsd30(param):
    if param['de_to_address_type'] == 'residential' and param['max_weight'] >= 30 and param['max_weight'] < 100:
        return {
...
def lr(param):
    if param['de_to_address_state'].lower() == 'wa' and param['de_to_address_city'] != 'Perth' and param['vx_service_name'] in ['Road Express', 'Fashion Express', 'Technology Express']:
        return {
