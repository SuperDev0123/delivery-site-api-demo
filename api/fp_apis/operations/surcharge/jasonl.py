...
def line_fee(param):
    ...
    pallet_w = int(param["width"])
    pallet_l = int(param["length"])
    is_pallet = param["is_pallet"]
    if is_pallet:
        if ((de_postal >= 3000 and de_postal <= 3207) or (de_postal >= 8000 and de_postal <= 8499)): # Melbourne
        ...
        elif ((de_postal >= 4000 and de_postal <= 4207) or (de_postal >= 9000 and de_postal <= 9499)): # Brisbane
            if (pallet_w <= 1.2 and pallet_l <= 1.2):
                return {
                    "name": "Pallet 1.2W * 1.2L or less",
        ...
        elif ((de_postal >= 5000 and de_postal <= 5199) or (de_postal >= 5900 and de_postal <= 5999)): # Adelaide
            if (pallet_w <= 1.2 and pallet_l <= 1.2):
                return {
                    "name": "Pallet 1.2W * 1.2L or less",
