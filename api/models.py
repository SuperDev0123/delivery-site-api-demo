...
class Bookings(models.Model):
	...
	b_dateBookedDate = models.DateTimeField(verbose_name=_('Booked Date'), default=datetime.now, blank=True, null=True)
	puPickUpAvailFrom_Date = models.DateField(verbose_name=_('PickUp Available From'), default=date.today, blank=True, null=True)
	...
	s_05_LatestPickUpDateTimeFinal = models.DateTimeField(verbose_name=_('Lastest PickUp DateTime'), default=datetime.now, blank=True, null=True)
	s_06_LatestDeliveryDateTimeFinal = models.DateTimeField(verbose_name=_('Latest Delivery DateTime'), default=datetime.now, blank=True, null=True)
	...
	pu_PickUp_By_Date = models.DateField(verbose_name=_('PickUp By Date'), default=date.today, blank=True, null=True)
	pu_addressed_Saved = models.IntegerField(verbose_name=_('PU Addressed Saved'), blank=True, null=True, default=0)
	b_date_booked_by_dme = models.DateField(verbose_name=_('Date Booked By DME'), default=date.today, blank=True, null=True)
	b_booking_Notes = models.TextField(verbose_name=_('Booking Notes'), max_length=400, blank=True, null=True, default='')
	s_02_Booking_Cutoff_Time = models.TimeField(verbose_name=_('Booking Cutoff Time'), auto_now_add=True, blank=True, null=True)
	s_05_Latest_PickUp_Date_Time_Override = models.DateTimeField(verbose_name=_('Latest PU DateTime Override'), default=datetime.now, blank=True, null=True)
	s_05_Latest_Pick_Up_Date_TimeSet = models.DateTimeField(verbose_name=_('Latest PU DateTime Set'), default=datetime.now, blank=True, null=True)
	s_06_Latest_Delivery_Date_Time_Override = models.DateTimeField(verbose_name=_('Latest DE DateTime Override'), default=datetime.now, blank=True, null=True)
	s_06_Latest_Delivery_Date_TimeSet = models.DateTimeField(verbose_name=_('Latest DE DateTime Set'), default=datetime.now, blank=True, null=True)
	...
	s_20_Actual_Pickup_TimeStamp = models.DateTimeField(verbose_name=_('Actual PU TimeStamp'), default=datetime.now, blank=True, null=True)
	s_21_Actual_Delivery_TimeStamp = models.DateTimeField(verbose_name=_('Actual DE TimeStamp'), default=datetime.now, blank=True, null=True)
	...
	v_serviceTime_End = models.TimeField(verbose_name=_('Service Time End'), auto_now_add=True, blank=True, null=True)
	v_serviceTime_Start = models.TimeField(verbose_name=_('Service Time Start'), auto_now_add=True, blank=True, null=True)
	...
	pu_PickUp_Avail_From_Date_DME = models.DateField(verbose_name=_('PU Available From Date DME'), default=date.today, blank=True, null=True)
	...
	pu_PickUp_By_Date_DME =  models.DateField(verbose_name=_('PU By Date DME'), default=date.today, blank=True, null=True)
	...
	pu_Actual_Date = models.DateField(verbose_name=_('PU Actual Date'), default=date.today, blank=True, null=True)
	pu_Actual_PickUp_Time = models.TimeField(verbose_name=_('Actual PU Time'), auto_now_add=True, blank=True, null=True)
	de_Deliver_From_Date = models.DateField(verbose_name=_('DE From Date'), default=date.today, blank=True, null=True)
	...
	de_Deliver_By_Date = models.DateField(verbose_name=_('DE By Date'), default=date.today, blank=True, null=True)
	...
	vx_freight_time = models.DateTimeField(verbose_name=_('Freight Time'), default=datetime.now, blank=True, null=True)
	...
	z_CreatedTimestamp = models.DateTimeField(verbose_name=_('Created By Account'), default=datetime.now, blank=True)
	z_ModifiedByAccount = models.CharField(verbose_name=_('Modified By Account'), max_length=25, blank=True, null=True, default='')
	z_ModifiedTimestamp = models.DateTimeField(verbose_name=_('Modified By Account'), default=datetime.now, blank=True)
	...
	de_to_TimeSlot_Date_End = models.DateField(verbose_name=_('DE to TimeSlot Date End'), default=date.today, blank=True, null=True)
	...
	b_client_Reference_RA_Numbers_lastupdate = models.DateTimeField(verbose_name=_('Client Reference RA Number Last Update'), default=datetime.now, blank=True, null=True)
	...
	z_included_with_manifest_date = models.DateTimeField(verbose_name=_('Included With Manifest Date'), default=datetime.now, blank=True, null=True)
	b_dateinvoice = models.DateField(verbose_name=_('Date Invoice'), default=date.today, blank=True, null=True)
	...
	z_lastStatusAPI_ProcessedTimeStamp = models.DateTimeField(verbose_name=_('Last StatusAPI Processed Timestamp'), default=datetime.now, blank=True, null=True)
	s_21_ActualDeliveryTimeStamp = models.DateTimeField(verbose_name=_('Actual Delivery Timestamp'), default=datetime.now, blank=True, null=True)
