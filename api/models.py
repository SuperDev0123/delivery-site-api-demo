...
class Bookings(models.Model):
	...
	b_dateBookedDate = models.DateTimeField(verbose_name=_('Booked Date'), default=datetime.now, blank=True)
	...
	s_05_LatestPickUpDateTimeFinal = models.DateTimeField(verbose_name=_('Lastest PickUp DateTime'), default=datetime.now, blank=True)
	s_06_LatestDeliveryDateTimeFinal = models.DateTimeField(verbose_name=_('Latest Delivery DateTime'), default=datetime.now, blank=True)
	...
	s_05_Latest_PickUp_Date_Time_Override = models.DateTimeField(verbose_name=_('Latest PU DateTime Override'), default=datetime.now, blank=True)
	s_05_Latest_Pick_Up_Date_TimeSet = models.DateTimeField(verbose_name=_('Latest PU DateTime Set'), default=datetime.now, blank=True)
	s_06_Latest_Delivery_Date_Time_Override = models.DateTimeField(verbose_name=_('Latest DE DateTime Override'), default=datetime.now, blank=True)
	s_06_Latest_Delivery_Date_TimeSet = models.DateTimeField(verbose_name=_('Latest DE DateTime Set'), default=datetime.now, blank=True)
	...
	vx_freight_time = models.DateTimeField(verbose_name=_('Freight Time'), default=datetime.now, blank=True)
	...
	b_client_Reference_RA_Numbers_lastupdate = models.DateTimeField(verbose_name=_('Client Reference RA Number Last Update'), default=datetime.now, blank=True)
	...
	z_included_with_manifest_date = models.DateTimeField(verbose_name=_('Included With Manifest Date'), default=datetime.now, blank=True)
...
class BOK_1_headers(models.Model):
	...
	date_processed = models.DateTimeField(verbose_name=_('date_processed'), default=datetime.now, blank=True)
	...
	b_024_b_pu_by_date = models.DateTimeField(verbose_name=_('b_024_b_pu_by_date'), default=datetime.now, blank=True)
	...
	b_047_b_del_avail_from_date = models.DateTimeField(verbose_name=_('b_047_b_del_avail_from_date'), default=datetime.now, blank=True)
	...
	b_050_b_del_by_date = models.DateTimeField(verbose_name=_('b_050_b_del_by_date'), default=datetime.now, blank=True)
	...
	b_021_pu_avail_from_date = models.DateTimeField(verbose_name=_('b_021_pu_avail_from_date'), default=datetime.now, blank=True)
