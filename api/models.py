...
class Bookings(models.Model):
	...
	s_20_Actual_Pickup_TimeStamp = models.DateTimeField(verbose_name=_('Actual PU TimeStamp'), default=datetime.now, blank=True)
	s_21_Actual_Delivery_TimeStamp = models.DateTimeField(verbose_name=_('Actual DE TimeStamp'), default=datetime.now, blank=True)
	...
	z_lastStatusAPI_ProcessedTimeStamp = models.DateTimeField(verbose_name=_('Last StatusAPI Processed Timestamp'), default=datetime.now, blank=True)
	s_21_ActualDeliveryTimeStamp = models.DateTimeField(verbose_name=_('Actual Delivery Timestamp'), default=datetime.now, blank=True)
...
class BOK_0_BookingKeys(models.Model):
	...
	timestampCreated = models.DateTimeField(verbose_name=_('PickUp Available From'), default=datetime.now)
...
class BOK_1_headers(models.Model):
	pk_auto_id = models.AutoField(primary_key=True)
	client_booking_id = models.CharField(verbose_name=_('Client booking id'), max_length=64, blank=True)
	b_021_b_pu_avail_from_date = models.DateTimeField(verbose_name=_('Available From'), default=datetime.now)
	...
	date_processed = models.DateTimeField(verbose_name=_('date_processed'), default=datetime.now)
	...
	b_024_b_pu_by_date = models.DateTimeField(verbose_name=_('b_024_b_pu_by_date'), default=datetime.now, null=True)
	...
	b_047_b_del_avail_from_date = models.DateTimeField(verbose_name=_('b_047_b_del_avail_from_date'), default=datetime.now, null=True)
	...
	b_050_b_del_by_date = models.DateTimeField(verbose_name=_('b_050_b_del_by_date'), default=datetime.now, null=True)
	...
	b_021_pu_avail_from_date = models.DateTimeField(verbose_name=_('b_021_pu_avail_from_date'), default=datetime.now, null=True)
...
class BOK_2_lines(models.Model):
	...
	date_processed = models.DateTimeField(verbose_name=_('Date Pocessed'), default=datetime.now, blank=True)
...
class Booking_Status_History(models.Model):
	...
	status_date = models.DateTimeField(verbose_name=_('Status Date'), default=datetime.now, blank=True)
	notes = models.TextField(verbose_name=_('Notes'), max_length=500, blank=True, null=True, default='')
	status_date_modified = models.DateTimeField(verbose_name=_('Status Date'), default=datetime.now, blank=True)
	...
	updateViaAPI = models.DateTimeField(verbose_name=_('Updated via API'), default=datetime.now, blank=True)
