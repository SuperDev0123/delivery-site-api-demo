...
class Bookings(models.Model):
    ...
    pu_Address_Street_1 = models.CharField(verbose_name=_('PU Address Street 1'), max_length=40, blank=True, null=True, default='')
    pu_Address_street_2 = models.CharField(verbose_name=_('PU Address Street 2'), max_length=40, blank=True, null=True, default='')
    ...
    dme_status_history_notes = models.CharField(max_length=500, blank=True, null=True, default='')
    dme_status_detail = models.CharField(max_length=100, blank=True, null=True, default='')
    dme_status_action = models.CharField(max_length=100, blank=True, null=True, default='')
    ...
    def get_client_item_references(self):
        try:
            ...
            booking_lines = Booking_lines.objects.filter(fk_booking_id=self.pk_booking_id)

            for booking_line in booking_lines:
                if booking_line.client_item_reference is not None:
                    if len(client_item_references) == 0:
                        client_item_references = client_item_references + booking_line.client_item_reference
                    else:
                        client_item_references = client_item_references + ", " + booking_line.client_item_reference
