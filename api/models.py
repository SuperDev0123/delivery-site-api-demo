...
class Bookings(models.Model):
	...
	s_02_Booking_Cutoff_Time = models.DateTimeField(verbose_name=_('Booking Cutoff Time'), default=timezone.now, blank=True, null=True)
	...
	v_serviceTime_End = models.DateTimeField(verbose_name=_('Service Time End'), default=timezone.now, blank=True, null=True)
	v_serviceTime_Start = models.DateTimeField(verbose_name=_('Service Time Start'), default=timezone.now, blank=True, null=True)
	...
	pu_Actual_PickUp_Time = models.DateTimeField(verbose_name=_('Actual PU Time'), default=timezone.now, blank=True, null=True)
	...
	pu_PickUp_TimeSlot_TimeEnd = models.DateTimeField(verbose_name=_('PU TimeSlot TimeEnd'), default=timezone.now, blank=True, null=True)
	de_TimeSlot_TimeStart = models.DateTimeField(verbose_name=_('DE TimeSlot TimeStart'), default=timezone.now, blank=True, null=True)
	de_Nospecific_Time = models.IntegerField(verbose_name=_('No Specific Time'), blank=True, default=0)
	de_TimeSlot_Time_End = models.DateTimeField(verbose_name=_('TimeSlot Time End'), default=timezone.now, blank=True, null=True)
