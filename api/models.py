...
class Bookings(models.Model):
	...
	b_date_booked_by_dme = models.DateField(verbose_name=_('Date Booked By DME'), default=datetime.date.today, blank=True, null=True)
	...
	pu_PickUp_Avail_From_Date_DME = models.DateField(verbose_name=_('PU Available From Date DME'), default=datetime.date.today, blank=True, null=True)
	...
	pu_PickUp_By_Date_DME =  models.DateField(verbose_name=_('PU By Date DME'), default=datetime.date.today, blank=True, null=True)
	...
	pu_Actual_Date = models.DateField(verbose_name=_('PU Actual Date'), default=datetime.date.today, blank=True, null=True)
	pu_Actual_PickUp_Time = models.TimeField(verbose_name=_('Actual PU Time'), auto_now_add=True, blank=True, null=True)
	de_Deliver_From_Date = models.DateField(verbose_name=_('DE From Date'), default=datetime.date.today, blank=True, null=True)
	...
	de_Deliver_By_Date = models.DateField(verbose_name=_('DE By Date'), default=datetime.date.today, blank=True, null=True)
	...
	de_to_TimeSlot_Date_End = models.DateField(verbose_name=_('DE to TimeSlot Date End'), default=datetime.date.today, blank=True, null=True)
...
class BOK_1_headers(models.Model):
	...
	b_000_b_total_lines = models.IntegerField(verbose_name=_('b_000_b_total_lines'), max_length=4, blank=True, null=True)
	...
	b_020_b_pu_num_operators = models.IntegerField(verbose_name=_('b_020_b_pu_num_operators'), max_length=2, blank=True, default=0, null=True)
	b_022_b_pu_avail_from_time_hour = models.IntegerField(verbose_name=_('b_022_b_pu_avail_from_time_hour'), max_length=2, blank=True, default=0, null=True)
	b_023_b_pu_avail_from_time_minute = models.IntegerField(verbose_name=_('b_023_b_pu_avail_from_time_minute'), max_length=2, blank=True, default=0, null=True)
	b_024_b_pu_by_date = models.DateTimeField(verbose_name=_('b_024_b_pu_by_date'), default=timezone.now, null=True)
	b_025_b_pu_by_time_hour = models.IntegerField(verbose_name=_('b_025_b_pu_by_time_hour'), max_length=2, blank=True, default=0, null=True)
	b_026_b_pu_by_time_minute = models.IntegerField(verbose_name=_('b_026_b_pu_by_time_minute'), max_length=2, blank=True, default=0, null=True)
	...
	b_042_b_del_num_operators = models.IntegerField(verbose_name=_('b_042_b_del_num_operators'), max_length=2, blank=True, default=0, null=True)
	...
	b_047_b_del_avail_from_date = models.DateTimeField(verbose_name=_('b_047_b_del_avail_from_date'), default=timezone.now, null=True)
	b_048_b_del_avail_from_time_hour = models.IntegerField(verbose_name=_('b_048_b_del_avail_from_time_hour'), max_length=2, blank=True, default=0, null=True)
	b_049_b_del_avail_from_time_minute = models.IntegerField(verbose_name=_('b_049_b_del_avail_from_time_minute'), max_length=2, blank=True, default=0, null=True)
	b_050_b_del_by_date = models.DateTimeField(verbose_name=_('b_050_b_del_by_date'), default=timezone.now, null=True)
	b_051_b_del_by_time_hour = models.IntegerField(verbose_name=_('b_051_b_del_by_time_hour'), max_length=2, blank=True, default=0, null=True)
	b_052_b_del_by_time_minute = models.IntegerField(verbose_name=_('b_052_b_del_by_time_minute'), max_length=2, blank=True, default=0, null=True)
